        ...
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <input type="hidden" name="id" value="${tbParkingUseInfo.id}">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="carNumber" autocomplete="off" placeholder="请输入车牌号码"
                                   class="layui-input" required="" lay-verify="required" value="${tbParkingUseInfo.carNumber}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="ownerName" autocomplete="off" placeholder="空制在80个汉字，160个字符以内"
                                   class="layui-input" required="" lay-verify="required" value="${tbParkingUseInfo.ownerName}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="telephone" autocomplete="off" placeholder="请输入数字"
                                   class="layui-input" required="" lay-verify="required" value="${tbParkingUseInfo.telephone}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="useType" value="1" title="租" <c:if test="${tbParkingUseInfo.useType==1}">checked="checked"</c:if>>
                            <div class="layui-unselect layui-form-radio "><i class="layui-anim layui-icon "></i>
                                <div>租</div>
                            </div>
                            <input type="radio" name="useType" value="0" title="售" <c:if test="${tbParkingUseInfo.useType==0}">checked="checked"</c:if>>
                            <div class="layui-unselect layui-form-radio"><i class="layui-anim layui-icon"></i>
                                <div>售</div>
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="money" autocomplete="off" placeholder="请输入数字"
                                   class="layui-input" required="" lay-verify="required" value="${tbParkingUseInfo.money}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" name="startTime" placeholder="开始时间" id="LAY_demorange_s"  value="<fmt:formatDate value="${tbParkingUseInfo.startTime}" pattern="yyyy-MM-dd" ></fmt:formatDate>" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" name="endTime" placeholder="开始时间" id="LAY_demorange_o"  value="<fmt:formatDate value="${tbParkingUseInfo.endTime}" pattern="yyyy-MM-dd" ></fmt:formatDate>" >
                        </div>
                    </div>
