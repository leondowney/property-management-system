    ...
    <div class="layui-header header header-demo">
        <div class="layui-main">
            ...
            <ul class="layui-nav" lay-filter="">
                ...
                <li class="layui-nav-item"><img src="../userImg/${user.img}" class="layui-circle" style="border: 2px solid #A9B7B7;" width="35px" height="35px" alt=""></li>
                ...
                <li class="layui-nav-item"> <a href="javascript:;">${user.realname}</a>
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd><a href="javascript:;"  onclick="one_set('个人信息','one_set.jsp','1000','600')">个人信息</a></dd>
    ...
    <div class="layui-side layui-bg-black x-side show_list" style="left:0px;" id="table1">
        <div style="height: 130px; width: 220px; ">
            <a class="img" title="我的头像" style="display: block;width: 80px;height: 80px;margin: 10px auto 10px;">
                <img src="../userImg/${user.img}" class="userAvatar" style="display: block;width: 100%;height: 100%;border-radius: 50%;-webkit-border-radius: 50%;-moz-border-radius: 50%;border: 4px solid #44576b;box-sizing: border-box;">
            </a>
            <p style=" display: block;width: 100%;height: 25px;color: #ffffff;text-align: center;font-size: 12px;white-space: nowrap;line-height: 25px;overflow: hidden;">
                你好！<span class="userName">${user.realname}</span>, 欢迎回来
            </p>
        </div>
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                ...
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;" _href="../welcome.jsp"> <i class="layui-icon left-nav-li" lay-tips="首页">&#xe68e;</i><cite>控制台</cite> </a>
                </li>
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="iconfont icon-dashaxiaoqudizhi01" style="top: 3px;"></i><cite>小区管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class=""> <a href="javascript:;" _href="../communitylist"> <cite>小区列表</cite> </a> </dd>
                        </dd>
                    </dl>
                </li>
                ...
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont icon-tingchewei" style="top: 3px;"></i><cite>停车位管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class=""> <a href="javascript:;" _href="../parklist"> <cite>车位管理</cite> </a> </dd>
                        <dd class=""> <a href="javascript:;" _href="../parkingusagelist"> <cite>车位使用管理</cite> </a> </dd>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont icon-fuwu" style="top: 3px;"></i><cite>服务管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class=""> <a href="javascript:;" _href="../activity_list"> <cite>活动管理</cite> </a> </dd>
                        <dd class=""> <a href="javascript:;" _href="../repair_list"> <cite>保修管理</cite> </a> </dd>
                        <dd class=""> <a href="javascript:;" _href="../complain_list"> <cite>投诉管理</cite> </a> </dd>
                        <dd class=""> <a href="javascript:;" _href="../letterBoxlist"> <cite>信箱管理</cite> </a> </dd>
                    </dl>
                </li>
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont icon-zichan" style="top: 3px;"></i><cite>资产管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class=""> <a href="javascript:;" _href="../decive/deciveList"> <cite>资产设备列表</cite> </a> </dd>
                    </dl>
                </li>
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont icon-shoufeizhan" style="top: 3px;"></i><cite>收费管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class=""> <a href="javascript:;" _href="../charges/chargesList"> <cite>收费项目</cite> </a> </dd>
                        <dd class=""> <a href="javascript:;" _href="../asset/assetList"> <cite>收费明细管理</cite> </a> </dd>
                    </dl>
                </li>
                <c:if test="${user.type==1}">
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon" style="top: 3px;">&#xe613;</i><cite>管理员管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class=""> <a href="javascript:;" _href="../admin/admin_list"> <cite>管理员列表</cite> </a> </dd>
        ...
        $.ajax({
            ...
            success:function (data) {
                if(data.code==200){
                    ...
                    setTimeout("window.location.href='../login.jsp'",2000);return false;
                    return false;
                }else{
