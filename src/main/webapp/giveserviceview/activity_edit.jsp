            ...
            <div class="layui-tab-content" >
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="xiaoQu" id="community_id">
                                <option value="">${activeEntity1.xiaoQu}</option>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="activeName" autocomplete="off" class="layui-input" value="${activeEntity1.activeName}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="activePath" autocomplete="off" class="layui-input" value="${activeEntity1.activePath}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="activeMaster" autocomplete="off"class="layui-input" value="${activeEntity1.activeMaster}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" name="startTime" id="LAY_demorange_s" value="<fmt:formatDate value="${activeEntity1.startTime}" pattern="yyyy-MM-dd"></fmt:formatDate> ">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" name="endTime" id="END_demorange_s" value="<fmt:formatDate value="${activeEntity1.endTime}" pattern="yyyy-MM-dd"></fmt:formatDate>" >
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="state1" id="stateId">
                                <c:if test="${activeEntity1.state==1}">
                                    <option value="1">有效</option>
                                </c:if>
                                <c:if test="${activeEntity1.state==0}">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="activeBody" autocomplete="off" class="layui-input" value="${activeEntity1.activeBody}">
                        </div>
                    </div>
...
<script>
    layui.use(['laydate','element','layer','form'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            $.ajax({
                type:"post",
                url:"${pageContext.request.contextPath}/activity_listUpdate",
