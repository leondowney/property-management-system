                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="xiaoQu" id="community_id">
                                <option value="">${complainEntity1.xiaoQu}</option>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="complainPersonnel" autocomplete="off" placeholder="空制在80个汉字，160个字符以内"
                                   class="layui-input" value="${complainEntity1.complainPersonnel}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="complainName" autocomplete="off" placeholder="空制在80个汉字，160个字符以内"
                                   class="layui-input" value="${complainEntity1.complainName}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="complainDescription" autocomplete="off" placeholder="空制在80个汉字，160个字符以内"
                                   class="layui-input" value="${complainEntity1.complainDescription}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-block">
                            <select name="state1" id="stateId">
                                <c:if test="${complainEntity1.state==1}">
                                    <option value="">已读</option>
                                </c:if>
                                <c:if test="${complainEntity1.state==0}">
...
<script>
    layui.use(['laydate','element','layer','form'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            $.ajax({
                type:"post",
                url:"${pageContext.request.contextPath}/complain_listUpdate",
