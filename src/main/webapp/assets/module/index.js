...
layui.define(["layer", "element", "admin"], function (g) {
    ...
    var q = {};
    var o = false;
    var n = {homeUrl: undefined, mTabPosition: undefined, mTabList: []};
    n.loadView = function (t) {
        if (!t.menuPath) {
            return m.msg("url不能为空", {icon: 2, anim: 6})
        }
        if (e.pageTabs) {
            var s;
            ...
            if (!s) {
                ...
                p.showLoading({elem: i('iframe[lay-id="' + t.menuPath + '"]').parent(), size: ""});
            ...
            if (r.length === 0) {
                ...
                p.showLoading({elem: r.parent(), size: ""});
    ...
    n.openTab = function (r) {
        ...
        n.loadView({menuPath: r.url, menuName: r.title})
    };
    ...
    j.on("nav(" + d + ")", function (v) {
        ...
        n.openTab({url: s, title: u, end: r});
        layui.event.call(this, "admin", "side({*})", {href: s})
    });
    j.on("tab(" + c + ")", function () {
        ...
        o = false;
        layui.event.call(this, "admin", "tab({*})", {layId: r})
    });
    j.on("tabDelete(" + c + ")", function (s) {
        ...
        if (r) {
            ...
            layui.event.call(this, "admin", "tabDelete({*})", {layId: r.menuPath})
        }
