        ...
        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
            ...
            <div class="layui-tab-content" >
                <div class="layui-tab-item layui-show">
                    <input type="hidden" name="id" value="${parkInfo.id}">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="zid" id="zid">
                                ...
                                <c:forEach var="communityInfo" items="${communityInfo}">
<%--                                    <option value="${communityInfo.id}" >${communityInfo.name}</option>--%>

                                    <c:if test="${communityInfo.id == parkInfo.zid}">
                                        <option value="${communityInfo.id}" selected>${communityInfo.name}</option>
                                    </c:if>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="parkNum" autocomplete="off" placeholder="车位编号"
                                   class="layui-input" value="${parkInfo.parkNum}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="parkName" autocomplete="off" placeholder="空制在80个汉字，160个字符以内"
                                   class="layui-input" value="${parkInfo.parkName}">
                        </div>
                    </div>
...
<%--                            <input type="radio" name="state" value="1" title="显示" ><c:if test="${park.state==1}"></c:if>--%>
<%--                            <div class="layui-unselect layui-form-radio layui-form-radioed"><i--%>
<%--                                    class="layui-anim layui-icon layui-anim-scaleSpring"></i>--%>
<%--                                <div>显示</div>--%>
<%--                            </div>--%>
<%--                            <input type="radio" name="state" value="0" title="隐藏" <c:if test="${park.state==0}"> checked="checked"> </c:if>--%>
...
<%--                    </div>--%>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block" >
                            <input type="radio" name="state" value="1" title="显示" <c:if test="${parkInfo.state==1}">checked="checked"</c:if>>
                            <div class="layui-unselect layui-form-radio layui-form-radioed"><i
                                    class="layui-anim layui-icon layui-anim-scaleSpring"></i>
                                <div>显示</div>
                            </div>
                            <input type="radio" name="statef" value="0" title="隐藏" <c:if test="${parkInfo.state==0}">checked="checked"</c:if>>
                            <div class="layui-unselect layui-form-radio"><i class="layui-anim layui-icon"></i>
                                <div>隐藏</div>
                            </div>
                        </div>
